...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			&copy; 2014 Ecommerce software by PrestaShop™ - {l s='[1]Customization by %s[/1]' mod='blockcms' sprintf=['Vagabond Dream OÜ'] tags=['<a class="_blank" href="http://www.VagabondDream.com">']}
		</div>
	</section>
	{/if}
	<!-- /MODULE Block footer -->
